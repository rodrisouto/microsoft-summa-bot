# summabot
Bot Framework v4 summa bot

This bot has been created using [Microsoft Bot Framework][1], !!!! what does it does?
...
- Clone the repository
    ```bash
    git clone https://github.com/rodrisouto/microsoft-summa-bot.git
    ```
- Install modules
    ```bash
    npm install
